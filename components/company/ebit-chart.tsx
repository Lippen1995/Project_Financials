...
export function EbitChart({
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="rounded-[1.25rem] border border-[#E4EAF0] bg-white px-3 py-3">
        <div className="relative overflow-x-auto">
          <div className="min-w-[620px]">
            {activePoint ? (
              <div className="pointer-events-none absolute right-4 top-3 rounded-[0.95rem] border border-[#E4EAF0] bg-white px-3 py-2 shadow-[0_12px_28px_rgba(15,23,42,0.08)]">

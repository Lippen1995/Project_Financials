...
export function AnnouncementDiscussionPanel({
  ...
  return (
    <div className="rounded-xl border border-[rgba(15,23,42,0.08)] bg-white p-4">
      ...
      {loading ? (
        <div className="mt-4 flex items-center gap-3 rounded-xl border border-[rgba(15,23,42,0.08)] bg-[rgba(248,249,250,0.72)] p-3 text-sm text-slate-600">
      ...
      {error ? (
        <div className="mt-4 rounded-xl border border-[rgba(146,91,33,0.16)] bg-[rgba(255,246,236,0.9)] p-3 text-sm leading-6 text-[#8a5b21]">
          {error}
        </div>
      ) : null}

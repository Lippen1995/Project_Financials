...
describe("mapRowsToCanonicalFacts", () => {
  it("normalizes OCR rows into canonical metrics without 1000x mistakes", () => {
    ...
    const rows: ReconstructedRow[] = [
      {
        pageNumber: 2,
        sectionType: "SUPPLEMENTARY_INCOME",
        unitScale: 1000,
        label: "Salgsinntekter",
        normalizedLabel: "salgsinntekter",
        noteReference: null,
        rowText: "Salgsinntekter 103097",
        y: 10,
        confidence: 0.9,
        values: [{ value: 103097, columnIndex: 0, x: 300 }],
      },
      {
        pageNumber: 2,
        sectionType: "SUPPLEMENTARY_INCOME",
        ...
        noteReference: null,
        rowText: "Driftsresultat 21210",
        y: 20,
        confidence: 0.9,
        values: [{ value: 21210, columnIndex: 0, x: 300 }],
      },
      {
        pageNumber: 2,
        sectionType: "SUPPLEMENTARY_INCOME",
        ...
        noteReference: null,
        rowText: "Årsresultat 18221",
        y: 30,
        confidence: 0.9,
        values: [{ value: 18221, columnIndex: 0, x: 300 }],
      },
      {
        pageNumber: 3,
        sectionType: "SUPPLEMENTARY_BALANCE",
        unitScale: 1000,
        label: "Sum eiendeler",
        normalizedLabel: "sum eiendeler",
        noteReference: null,
        rowText: "Sum eiendeler 92155",
        y: 10,
        confidence: 0.9,
        values: [{ value: 92155, columnIndex: 0, x: 300 }],
      },
      {
        pageNumber: 3,
        sectionType: "SUPPLEMENTARY_BALANCE",
        ...
        noteReference: null,
        rowText: "Sum egenkapital 36372",
        y: 20,
        confidence: 0.9,
        values: [{ value: 36372, columnIndex: 0, x: 300 }],
      },
      {
        pageNumber: 3,
        sectionType: "SUPPLEMENTARY_BALANCE",
        ...
        noteReference: null,
        rowText: "Sum gjeld 55783",
        y: 30,
        confidence: 0.9,
        values: [{ value: 55783, columnIndex: 0, x: 300 }],
      },
      {
        pageNumber: 3,
        sectionType: "SUPPLEMENTARY_BALANCE",
        ...
        noteReference: null,
        rowText: "Sum egenkapital og gjeld 92155",
        y: 40,
        confidence: 0.9,
        values: [{ value: 92155, columnIndex: 0, x: 300 }],
      },
  ...
  it("flags suspicious year-column order instead of silently swapping years", () => {
    ...
    expect(result.issues.some((issue) => issue.ruleCode === "YEAR_COLUMN_ORDER_SUSPICIOUS")).toBe(true);
  });
});

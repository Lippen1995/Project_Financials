...
Generated at: 2026-04-25T08:30:11.044Z
...
- Route decision: hybrid/full (FORCED_HYBRID), requires OCR
...
- ODL failing reason: Hybrid returned only image blocks without text or table structure, so downstream statement detection had no usable signals.
- ODL raw output: elements=25, textElements=0, tables=0, pages=25, types=image:25
- ODL normalized output: pages=25, blocks=25, tables=0, blockKinds=picture:25
- ODL annual-report pages: pages=25, lines=0, tables=0, statementSignalsPresent=false, imageOnlyRawOutput=true
- Cross-engine divergence: none
- Cross-engine summary: No material divergence detected.

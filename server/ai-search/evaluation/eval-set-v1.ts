...
const cases: NjordEvaluationCase[] = [
  ...
  { id: "facts-05", category: "FACTS", question: "Sammenlign selskapet i evalueringskonteksten med offisielle peers.", expectedOutcome: "GROUNDED_ANSWER", requiredTools: ["resolve_company", "find_comparables"], requiredEvidenceKinds: ["DOCUMENTED_FACT", "CALCULATION"] },
  { id: "facts-06", category: "FACTS", question: "Vis registrert navn, status, næring og kommune for evalueringsselskapet.", expectedOutcome: "GROUNDED_ANSWER", requiredTools: ["resolve_company", "get_company_profile"], requiredEvidenceKinds: ["DOCUMENTED_FACT"] },
  { id: "facts-07", category: "FACTS", question: "Finn relevante selskaper ut fra den dokumenterte virksomhetsbeskrivelsen.", expectedOutcome: "GROUNDED_ANSWER", requiredTools: ["find_by_business"], requiredEvidenceKinds: ["DOCUMENTED_FACT"] },
  { id: "facts-08", category: "FACTS", question: "Vis siste tilgjengelige strukturerte Brreg-regnskap for evalueringsselskapet.", expectedOutcome: "GROUNDED_ANSWER", requiredTools: ["get_company_profile"], requiredEvidenceKinds: ["DOCUMENTED_FACT"] },

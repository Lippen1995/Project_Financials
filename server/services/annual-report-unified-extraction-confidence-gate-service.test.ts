  ...
  describe("FAIL cases", () => {
    ...
    it("COMPARISON_MATCH_RATE fails when below fail threshold", () => {
      const report = buildUnifiedExtractionConfidenceGateReport(
        makeInput({
          comparison: makeComparison([
            { canonicalKey: "revenue", year: 2024, legacyValueNok: "1000000", unifiedValueNok: "2000000", deltaNok: "1000000", match: "MISMATCH", relativeDeviation: 1.0 },
            { canonicalKey: "net_income", year: 2024, legacyValueNok: "100000", unifiedValueNok: "200000", deltaNok: "100000", match: "MISMATCH", relativeDeviation: 1.0 },
            { canonicalKey: "total_assets", year: 2024, legacyValueNok: "500000", unifiedValueNok: "1000000", deltaNok: "500000", match: "MISMATCH", relativeDeviation: 1.0 },
          ]),

          ...
          statements: [
            {
              ...
              ebit: 100n,
              preTaxProfit: 90n,
              preTaxProfitStatus: "AVAILABLE" as const,
              netIncome: 70n,
              equity: 400n,
              totalAssets: 800n,
              financialDatasetVersion: "reported:7",
          ...
          statements: [
            {
              ...
              reportedStatementId: "statement-current",
              orgNumber: "999999999",
              fiscalYear: 2025,
              statementScope: "COMPANY" as const,
              currency: "NOK",
              ...
              valueOrigin: "reported" as const,
              reportedSourceSystem: "BRREG",
              reportedSourceId: "filing-current",
              sourceFilingId: "filing-current",
              publishedAt: new Date("2026-07-01T00:00:00.000Z"),
              financialFetchedAt: new Date("2026-07-02T00:00:00.000Z"),
              financialNormalizedAt: new Date("2026-07-02T00:01:00.000Z"),
            },
            {
              ...
              reportedStatementId: "statement-historical",
              orgNumber: "888888888",
              fiscalYear: 2024,
              statementScope: "COMPANY" as const,
              currency: "NOK",
              ...
              ebit: null,
              preTaxProfit: null,
              preTaxProfitStatus: "MISSING" as const,
              netIncome: 25n,
              equity: 200n,
              totalAssets: 350n,
              financialDatasetVersion: "reported:7",
              valueOrigin: "reported" as const,
              reportedSourceSystem: "BRREG",
              reportedSourceId: "filing-historical",
              sourceFilingId: "filing-historical",
              publishedAt: new Date("2025-07-01T00:00:00.000Z"),
              financialFetchedAt: new Date("2025-07-02T00:00:00.000Z"),
              financialNormalizedAt: new Date("2025-07-02T00:01:00.000Z"),
            },

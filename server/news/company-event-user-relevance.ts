...
const EVENT_BASE_RELEVANCE: Record<string, number> = {
  profit_warning: 0.38,
  going_concern_risk: 0.38,
  auditor_warning: 0.34,
  bankruptcy: 0.4,
  reconstruction: 0.36,
  forced_dissolution: 0.34,
  liquidation: 0.34,
  mna: 0.34,
  listing: 0.32,
  delisting: 0.32,
  ...
  capital_raise: 0.32,
  share_issue: 0.3,
  debt_refinancing: 0.3,
  bond_issue: 0.28,
  guidance_upgrade: 0.3,
  guidance_downgrade: 0.34,
  margin_pressure: 0.28,
  cash_flow_issue: 0.34,
  contract_award: 0.28,
  procurement_tender: 0.22,
  contract_loss: 0.32,
  asset_sale: 0.28,
  spin_off: 0.28,
  restructuring: 0.28,
  strategic_review: 0.24,
  insider_transaction: 0.24,
  ownership_change: 0.24,
  annual_report: 0.28,
  financial_statement: 0.28,
  earnings: 0.2,
  reporting_calendar: 0.1,
  ceo_change: 0.24,
  cfo_change: 0.22,
  board_change: 0.18,
  auditor_change: 0.2,
  production_update: 0.24,
  capacity_expansion: 0.24,
  project_delay: 0.3,
  cost_overrun: 0.32,
  license_award: 0.24,
  license_loss: 0.34,
  legal_settlement: 0.3,
  lawsuit: 0.28,
  tax_dispute: 0.28,
  fine: 0.26,

...
| C-07 | Njord / AI | Ekte modell etter bestått evaluering | OpenAI er kandidat; Terra primær kandidat og Luna kostnadsutfordrer; Sol ekskludert som for dyr | Input-, cache- og outputtokens, verktøy, feil og retries | Foreslått NOK 225 evaltak innen NOK 2 500/mnd hardt maksimum | Kandidatpriser kontrollert 29. juli 2026; må revalideres ved aktivering | Simen Lippestad | G1 |
...
| 29. juli 2026 | C-07 beslutningsunderlag | [AI-delunderlaget til G1](./sprint-3/g1-ai-decision-pack.md) anbefaler Terra som primær kandidat, Luna som kostnadsutfordrer, 15 prosent valutabuffer og en separat evalueringsramme på NOK 225. Foreslått G1-A/G1-B er ikke en godkjent endring av porten. Dette er en anbefaling, ikke en godkjenning eller aktivering. | Avventer CEO |
| 29. juli 2026 | C-07 kandidatvalg | Sol ekskluderes fra G1-evalueringen fordi tokenprisen er for høy. AI-delunderlaget anbefaler Terra og Luna som erstatning, men dette kandidatparet avventer beslutning og aktiverer ingen modell eller kostnad. | Simen Lippestad (CEO) |

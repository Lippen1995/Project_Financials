# FI-SIM valideringsrapport: fi-sim-investor-2026.1-20260810-a

Datasettet er skrevet og validert.

| | |
|---|---|
| Kjørt | 2026-08-10T09:14:55.305Z |
...
Hovedtotalene under er beregnet fra det eksakte publiserbare utvalget og avstemt mot det
validerte, immutable datasettet etter vellykket skriving. Profil-, scope-, residual- og
utelatelsesfordelingen kommer fra den samme deterministiske genereringskjøringen; den fullstendige
utelatelseslisten ligger også i dataset-manifestet. De 18 genererte periodene som krevde manuell
kontroll ble ikke skrevet og er listet separat nederst i rapporten.
...
| Rapporterte ankerlinjer | 74645 |
| Syntetiske linjer | 982720 |
...
| SERVICE | 17660 |
| TRADE | 6511 |
| MANUFACTURING_CONSTRUCTION | 5872 |
| PROPERTY | 2988 |
...
| Konsept | Antall |
|---|---|
| ProfitForPeriod | 5954 |
| AssetsTotal | 5954 |
| EquityTotal | 5951 |
| CurrentAssetsTotal | 5940 |
| LiabilitiesTotal | 5920 |
| ProfitBeforeTax | 5916 |
| OperatingResult | 5788 |
| OperatingIncomeTotal | 5763 |
| OperatingExpenseTotal | 5732 |
| CurrentLiabilitiesTotal | 5701 |
| AccumulatedResults | 5637 |
| NetFinancialResult | 5552 |
| LongTermLiabilitiesTotal | 4837 |
...
| Feilkode | Antall |
|---|---|
| CONTRADICTORY_REPORTED_ANCHORS | 1225 |
| INVALID_PERIOD | 830 |
